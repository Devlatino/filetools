...
const TOOLS_LIST = [
  ...
  { slug: "pdf-to-word", name: "PDF to Word", description: "Convert PDF to editable Word DOCX", category: "PDF", input: ["application/pdf"], output: ["application/vnd.openxmlformats-officedocument.wordprocessingml.document"], free: true, serverUpload: false, useCases: ["Edit content from a PDF", "Reuse PDF text in Word"] },
  { slug: "pdf-to-excel", name: "PDF to Excel", description: "Extract PDF tables into XLSX", category: "PDF", input: ["application/pdf"], output: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"], free: true, serverUpload: false, useCases: ["Extract tables from PDF", "Reuse PDF data in Excel"] },
  { slug: "pdf-to-pptx", name: "PDF to PowerPoint", description: "Convert PDF to PowerPoint PPTX", category: "PDF", input: ["application/pdf"], output: ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], free: true, serverUpload: false, useCases: ["Turn PDF pages into slides", "Reuse PDF in presentations"] },
  { slug: "powerpoint-to-pdf", name: "PowerPoint to PDF", description: "Convert PPTX to PDF", category: "PDF", input: ["application/vnd.openxmlformats-officedocument.presentationml.presentation"], output: ["application/pdf"], free: true, serverUpload: false, useCases: ["Share slides as PDF", "Print-ready presentation"] },
  ...
  { slug: "csv-to-excel", name: "CSV to Excel", description: "Convert CSV to XLSX", category: "DEVELOPER", input: ["text/csv"], output: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"], free: true, serverUpload: false, useCases: ["Open CSV in Excel natively", "Fix formatting issues"] },
  { slug: "excel-to-csv", name: "Excel to CSV", description: "Convert XLSX to CSV", category: "DEVELOPER", input: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/vnd.ms-excel"], output: ["text/csv"], free: true, serverUpload: false, useCases: ["Export Excel to CSV", "Data processing"] },
  ...
  { slug: "audio-converter", name: "Audio Converter", description: "Convert audio formats natively", category: "AUDIO", input: ["audio/*"], output: ["audio/*"], free: true, serverUpload: false, useCases: ["Convert to WAV", "Convert to OGG", "Convert to AAC"] },
  // CAD & 3D
  ...
  { slug: "encrypt-file", name: "Encrypt & Decrypt File", description: "Securely encrypt or decrypt files with a password", category: "UTILITY", input: ["*"], output: ["*"], free: true, serverUpload: false, useCases: ["Password protect files", "Secure data for email"] },
  ...
  { slug: "sql-formatter", name: "SQL Formatter", description: "Format and validate SQL", category: "DEVELOPER", input: ["text/plain"], output: ["text/plain"], free: true, serverUpload: false, useCases: ["Pretty-print SQL queries", "Indent complex joins"] },
  ...
  { slug: "word-counter", name: "Word Counter", description: "Count words, characters, sentences and reading time", category: "DEVELOPER", input: ["text/plain"], output: ["text/plain"], free: true, serverUpload: false, useCases: ["Article length", "SEO meta length", "Reading time"] },
  { slug: "text-case-converter", name: "Text Case Converter", description: "Convert text to uppercase, lowercase, camelCase, snake_case and more", category: "DEVELOPER", input: ["text/plain"], output: ["text/plain"], free: true, serverUpload: false, useCases: ["Variable names", "Titles", "URL slugs"] },
  { slug: "lorem-ipsum-generator", name: "Lorem Ipsum Generator", description: "Generate placeholder text as paragraphs, words or HTML", category: "DEVELOPER", input: [], output: ["text/plain", "text/html"], free: true, serverUpload: false, useCases: ["Design mockups", "Placeholder content", "HTML templates"] },
  { slug: "color-picker", name: "Color Picker", description: "Pick and convert colors between HEX, RGB, HSL, CMYK. Generate harmonies and check WCAG contrast.", category: "DEVELOPER", input: [], output: ["text/plain"], free: true, serverUpload: false, useCases: ["Web design", "CSS variables", "Color palettes"] },
  { slug: "url-encoder-decoder", name: "URL Encoder / Decoder", description: "Encode, decode or parse URLs. Percent-encoding and URL components.", category: "DEVELOPER", input: ["text/plain"], output: ["text/plain"], free: true, serverUpload: false, useCases: ["API parameters", "Query strings", "URL parsing"] },
  { slug: "hash-generator", name: "Hash Generator", description: "Generate MD5, SHA-1, SHA-256, SHA-384, SHA-512 hashes. Hash text or files. HMAC and verify.", category: "DEVELOPER", input: ["text/plain"], output: ["text/plain"], free: true, serverUpload: false, useCases: ["File integrity", "Checksums", "API signing"] },
];
